 ...
 */
/**
 * \file htdocs/includes/modules/modOAuthGoogleContacts.class.php
...
class modOAuthGoogleContacts extends DolibarrModules {
  ...
  function modOAuthGoogleContacts($DB) {
    ...
    $this->requiredby = array("modGoogleContacts"); // List of modules id to disable if this one is disabled
    ...
    $this->const = array(0=>array('OAUTHGOOGLECONTACTS_VERSION','chaine','1.0','Version du module',0),
                         1=>array('ZF_CONTRAT_ASSISTANCE','chaine','0','Type de contrat',0)); // List of particular constants to add when module is enabled (key, 'chaine', value, desc, visible, 0 or 'allentities')
