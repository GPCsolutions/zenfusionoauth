 ...
 */
/**
 * \file htdocs/oauthgooglecontacts/oauth_google_contacts.class.php
...
class Oauth_google_contacts extends CommonObject
{
  ...
  function create($user, $notrigger = 0)
  {
    ...
    $error = 0;
    // Clean parameters
    if (isset($this->access_token)) $this->access_token = trim($this->access_token);
    if (isset($this->secret_token)) $this->secret_token = trim($this->secret_token);
  ...
  function update($user = 0, $notrigger = 0)
  {
    ...
    $sql.= " access_token=" . (isset($this->access_token) ? "'" . addslashes($this->access_token) . "'" : "null") . ",";
    $sql.= " secret_token=" . (isset($this->secret_token) ? "'" . addslashes($this->secret_token) . "'" : "null") . "";
